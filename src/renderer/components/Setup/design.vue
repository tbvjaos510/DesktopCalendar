<template>
  <div class="uk-margin-large-top uk-text-center">
    ...
    <br>
    <span class="uk-text-meta">나중에 설정에서 세부적으로 설정할 수 있습니다.</span>
    <table class="uk-table uk-margin-remove-top">
      ...
      <tbody>
        <tr>
          <td>
            <img class="uk-width-4-5" src="static/black.png"/>
          </td>
          <td>
            <img class="uk-width-4-5" src="static/white.png"/>
          </td>
        </tr>
      </tbody>
    </table>
    
    <vk-button class="uk-position-medium uk-position-top-right" type="primary" size="small" uk-slideshow-item="3">다음</vk-button>
  </div>
</template>
...
export default {
  ...
  computed: {
    settings: {
      ...
      set (value) {
        this.$store.commit('setAll', value)
      }
    }
  },
  mounted () {
