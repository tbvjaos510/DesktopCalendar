<template>
  <div>
    <div class="uk-margin-large-top uk-text-center">
      <div v-if="!isAuthed">
        <p class="uk-text-lead">동기화하려면 Google 계정 로그인이 필요합니다.</p>
      ...
      <div class="uk-width-large uk-align-center" v-else>
        <p class="uk-text-lead">사용할 달력을 선택하세요. <vk-button class="uk-position-medium uk-position-top-right" type="primary" size="small" uk-slideshow-item="2" @click="save">다음</vk-button></p>
